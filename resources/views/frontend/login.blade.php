     ...
     <p class="connexion">Se Connecter</p>
        ...
        <form action="{{route('loginPost')}}" id="loginForm" method="post">
            ...
            <div class="con">
                    ...
                    <div class="row p-0">
                        <div class="">
                            <input type="email" name="email" id="phone" placeholder="dodo@dodo" style="border:1px black solid;">
                        </div>

                    </div><br>
                    <div class="row p-0">
                        <div class="">
                            <input type="password" name="password" id="phone" placeholder="pass*****" style="border:1px black solid; background-color:transparent;">
                        </div>
            ...
            <div class="lower">
                <button class="btn bouton" type="submit" id="loader">Se connecter</button>
            </div>
            
                <br> 
            <div class="cpt">
            <p class="mb-0">Je n'ai pas de compte</p><a href="{{route('register')}}" class="text-info">S'enregistrer </a>
        </div>
        <br>
